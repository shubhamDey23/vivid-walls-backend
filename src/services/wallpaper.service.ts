...
export const wallpaperService = {
  ...
  async getById(id: string) {
    ...
    if (!wallpaper) {
      throw ApiError.notFound(`Wallpaper ${id} not found`);
    }
  ...
  // CREATE SINGLE
  async create(data: CreateWallpaperInput) {
  ...
  // BATCH UPLOAD
  async createMany(wallpapers: CreateWallpaperInput[]) {
  ...
  async update(id: string, data: Prisma.WallpaperUpdateInput) {
